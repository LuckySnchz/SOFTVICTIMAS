...
<!Listado profesionales>
    ...
    <ul>
      ...
      <form class="" action="/agregarProfesional" method="post" onsubmit='return validar()'>
      {{csrf_field()}}
...
<div id ="newprof"class="form-group"{{ $errors->has('nuevo_profesional_si') ? 'has-error' : ''}}>
    <label for="">Desea agregar un nuevo profesional?:</label>
...
<div class="botones">
      <div class="btn-1"> <button type="submit" class="btn btn-primary col-xl" name="button"  >Agregar/Enviar</button><br><br></div>
               ...
               <a type="button" href="/agregarVictima" target="_self" style="width:100%; color:white;background-color:rgb(137, 210, 14)" class="btn col-XL" class="btn btn-danger">SIGUIENTE</button> </a><br><br>
      </section>
