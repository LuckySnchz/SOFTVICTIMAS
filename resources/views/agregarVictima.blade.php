...
@else
    ...
    <label for="">B 1. Nombre y apellido:</label>
    <input type="text" class="form-control" name="victima_nombre_y_apellido" id="victima_nombre_y_apellido" value="{{session("idVictim")}}">
...
<strong><span>*Ingresa el número de teléfono, si es celular sin el 15. Característica sin el 0 y Presiona Ingresar!!</span></strong><br>
    ...
    <input name="telefono_victima"  style="background-color: #e9ecef;color:black" placeholder="Ingresar 10 dígitos, el sisrema le dará el formato 221-463-2683 o 114-563-2889" value="{{old('telefono_victima')}}"   id="telefono_victima" class="form-control" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" onKeypress="addDashesPhoneUno(this)"  type="tel" readonly="readonly"/>
...
<strong><span>*Ingresa el número de teléfono, si es celular sin el 15. Característica sin el 0 y Presiona Ingresar!!</span></strong><br>
    <input type="tel" name="telefono_victima" placeholder="Ingresar 10 dígitos, el sisrema le dará el formato 221-463-2683 o 114-563-2889" style="background-color: white;color:black" value="{{old('telefono_victima')}}"   id="telefono_victima" class="form-control" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" onKeypress="addDashesPhoneUno(this)" required >
...
<strong><span>*Ingresa el número de teléfono, si es celular sin el 15. Característica sin el 0 y Presiona Ingresar!!</span></strong><br>
    ...
    <input name="otro_telefono_victima" style="background-color: #e9ecef;color:black" value="{{old('otro_telefono_victima')}}"   id="otro_telefono_victima" class="form-control" placeholder="Ingresar 10 dígitos, el sisrema le dará el formato 221-463-2683 o 114-563-2889" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" onKeypress="addDashesPhoneDos(this)" type="tel" readonly="readonly"/>
...
<strong><span>*Ingresa el número de teléfono, si es celular sin el 15. Característica sin el 0 y Presiona Ingresar!!</span></strong><br>
    <input type="tel" name="otro_telefono_victima" placeholder="Ingresar 10 dígitos, el sisrema le dará el formato 221-463-2683 o 114-563-2889" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" onKeypress="addDashesPhoneDos(this)" style="background-color: white;color:black" value="{{old('otro_telefono_victima')}}"   id="otro_telefono_victima" class="form-control"  required >
...
<!B6 Documentación>
   ...
   <!B6 Documentación>
    ...
    <select class="form-control" name="tienedoc" onChange="selectOnChangeB6(this)">
            ...
            @if (old("tienedoc") == 2)<option value="2" selected>No posee</option>
            @else <option value="2" >No posee</option> @endif

            @if (old("tienedoc") == 3)<option value="3" selected>En tramite</option> @else <option value="3">En tramite</option>@endif

            @if (old("tienedoc") == 4)<option value="4" selected>Se desconoce</option> @else<option value="4" >Se desconoce</option> @endif
    </select>
         ...
         function selectOnChangeB6(sel) {
          if (sel.value=="1"||sel.value=="3"){
              ...
              divV.style.display = "";
               ...
               divV = document.getElementById("ndoc");
              divV.style.display = "";
...
divCDDd = document.getElementById("bloqueo8").checked=false;
          }
         }
      </script>
...
<!B7 Tipo documentación>
  ...
  @if (old("tienedoc") == 1||old("tienedoc") == 3) 
    ...
    <select class="form-control" id="tipodocumento_id" name="tipodocumento" onChange="selectOnChangeB7(this)">
       <option value="" selected=disabled>Seleccionar...</option>
        @if(old("tipodocumento") ==1)<option value="1" selected>D.N.I.</option> 
    ...
    @if (old("tipodocumento") == 6) 
    <div id="cual_b14" {{ $errors->has('residenciaprecaria') ? 'has-error' : ''}}>
    @else 
...
<div id="ndoc">
 ...
 <label for="">B 9. Nro Documento:</label>
    ...
    <label class="form-check-label" >Se desconoce</label>
    <input name="victima_numero_documento" value="0" id="bloqueo8" type="checkbox" checked onchange="checkB8(this)">
    ...
    <label class="form-check-label" >Se desconoce</label>
    <input name="victima_numero_documento" value="0" id="bloqueo8" type="checkbox" onchange="checkB8(this)">
  @endif
...
@else
  ...
  <label>B 12 I. Necesidades socioeconómicas insatisfechas: <strong>*Si posee un dato diferente a Se Deconoce seleccionelo!</strong> </label><br>
  <label>En caso de requerir, tildar todas las opciones que considere correspondientes.</label><br>
              @foreach ($necesidades as $necesidad)
                <label class="form-check-inline form-check-label">
                @if(is_array(old("necesidades")) && in_array($necesidad->id, old("necesidades")))
...
@if((old("genero")==2) || (old("genero")==3))
  ...
  <select class="form-control" id="embarazorelevamiento_id" name="embarazorelevamiento" style="background-color: grey;color:white">
          ...
          @else <option value="2" selected >Se Desconoce</option> @endif
...
<div id="b14Hidden"class="form-group"{{ $errors->has('discapacidades') ? 'has-error' : ''}}>
...
@if(old("tienelesion") == 1)
  ...
  @else
    ...
    <label class="">B 16I.Tipo de lesión:</label>
...
<div class="form-group" id="limitacionesSi" style="display:none">
  B 18I Tipo de limitación para comunicarse:
    <label>En caso de requerir, tildar todas las opciones que considere correspondientes.</label><br>
    <div>
      @foreach ($limitaciones as $limitacion)
          <label class="form-check-inline form-check-label">
...
<!BOTONES>
    ...
    <div class="botones">
    <div class="btn-1"> <button type="submit" class="btn btn-primary col-xl" name="button" onclick="recibir();" >Agregar/Enviar</button><br><br></div>
    </div>
    </form>
    </section>
