        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background-color:rgb(137, 210, 14)" >
            <div class="container">
                <a class="navbar-brand">
                    <h3 style="color:white;text-align: center;margin-left: 15%">Dirección Provincial del Centro de Protección de los Derechos de la Víctima</h3>
                </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                 ...
                                 <a class="dropdown-item" href="/password/change">
                                    ...
                                    <a class="dropdown-item" href="/storage/manual.pdf">
                                        {{ __('Manual de Carga') }}
                                    </a>
