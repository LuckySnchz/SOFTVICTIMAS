...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="panel"style="background-color:rgb(137, 210, 14);text-align: center;margin-bottom: 0.1%;margin-top: 0.2%">
   ...
   <body>
      <h1 class="text-center" style="padding: 15px;">Incidencias:</h1>
      ...
      <section class="container jumbotron shadow p-3 mb-5 bg-white rounded">
        ...
        @endif
         ...
         <form class="" action="/detallepasarAcaso" method="post">
                {{csrf_field()}}
...
<select class="form-control" name="delito" onChange="selectOnChangeA2(this)">
    ...
    @if ($caso->delito == 37) <div id="cualA2" {{ $errors->has('otro_delito') ? 'has-error' : ''}}>
    @else
...
<!-A5 Modalidad de ingreso->
   ...
   <!-A5 Modalidad de ingreso->
        ...
        @if($caso->modalidad_ingreso== 3) <div id="derivacion_otro_organismo_id" {{ $errors->has('organismo') ? 'has-error' : ''}}>
...
<select class="form-control" name="organismo" id="organismo" onChange="selectOnChangeA5(this)">
 ...
 {!! $errors->first('organismo', '<p class="help-block" style="color:red";>:message</p>') !!}
    ...
    @if ($caso->organismo== 24) <div id="cualA5" {{ $errors->has('otro_organismo') ? 'has-error' : ''}}>
    @else
    <div id="cualA5" style="display: none">
    @endif
    <label for="">Cuál?</label>
    <input name="otro_organismo"  id="otro_organismo" class="form-control" type="text" 
    value="{{$caso->otro_organismo}}">
...
<!-A15 Localidad del hecho->
 ...
 @if(($caso->provincia_hecho) < 25 && ($caso->pais_hecho)==1)
