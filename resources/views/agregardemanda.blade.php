...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <style>
         ...
         .message{z-index: 100;margin-top: 80%}
      </style>
   </head>
     <header>
...
<!-1 Tipo de delito->
    ...
    <label for="">1. Tipo de delito:</label>
...
<!-2 Fecha de ingreso->
        ...
        <label for="datos_fecha_ingreso">2. Fecha de Ingreso:</label>
...
<!-3 Modalidad de ingreso->
        ...
        <label for="modalidad_ingreso">3. Modalidad de Ingreso</label>
  ...
  <label>3 .I Qué organismo derivó?</label>
...
<!-4 Nombre y apellido de la victima->

  <div class="form-group "{{ $errors->has('nombre_y_apellido_de_la_victima') ? 'has-error' : ''}}>
  <label for="">4. Nombre y apellido de la víctima:</label>
  ...
  <!-5 Tipo de fecha->
      ...
      <label>5. Tipo de fecha del hecho:</label>
  ...
  <div class="form-group"{{ $errors->has('fecha_hecho') ? 'has-error' : ''}}>
       <label for="">5 I. Fecha del hecho: </label>
    ...
    @endif
      <label for="">5 II. Descripción de periodo de fechas del hecho: </label>
...
<!6 País del hecho->
    ...
    <label for="countryId2">6. País del hecho:</label>
...
<!-7 Provincia del hecho->
  ...
  <div class="form-group" id="provincia_hecho" style="display: none">
    @endif
    <label for="stateId2">7. Provincia del hecho:</label>
...
@endif
    <label for="cityId2">8. Localidad del hecho:</label>
